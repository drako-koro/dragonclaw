/**
 * Default idle tasks for DragonClaw autonomous mode.
...
Be specific with file paths and sizes. Format as an actionable checklist the author can review.`,
  },
  {
    ...
    enabled: true,
    prompt: `You are a system diagnostics specialist for DragonClaw, an AI-powered writing agent. Perform a comprehensive health check of the workspace and system configuration:
...
6. **Recommendations**: Provide 3-5 specific actions the author should take to improve their DragonClaw setup.
