...
description: Advanced 47-marker voice analysis engine — analyzes your writing to build a comprehensive Voice Profile for DragonClaw
...
Saved to `workspace/soul/VOICE-PROFILE.md` with all 47 markers organized into sections that DragonClaw's Soul system reads on every interaction.
