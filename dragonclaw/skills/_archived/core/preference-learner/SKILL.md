...
Every author is different. This skill builds a living profile of the user's preferences, habits, and working style — then applies it to every interaction so DragonClaw feels increasingly personalized.
...
The user directly tells DragonClaw their preferences:
...
- Machine-parseable (DragonClaw loads it into context)
- Versioned (changes are logged with timestamps)

## Applying Preferences

Before each interaction, DragonClaw:
