...
You are DragonClaw's self-learning module. When the user says "go learn about X" or
...
Create a properly formatted skill file following DragonClaw's skill schema:
