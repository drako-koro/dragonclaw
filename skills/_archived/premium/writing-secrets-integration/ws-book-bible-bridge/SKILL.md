...
description: Import and sync Book Bible Engine JSON data into DragonClaw's memory system
...
Seamlessly import data from Writing Secrets' Book Bible Engine into DragonClaw's memory system.

## Supported Import Formats

This skill reads the JSON export from Book Bible Engine and maps it directly into DragonClaw's book-bible memory structure.
...
3. Map each entity type to DragonClaw's book-bible format:
...
When the author makes changes in DragonClaw's book bible:
