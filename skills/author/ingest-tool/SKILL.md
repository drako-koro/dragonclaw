---
name: ingest-tool
description: Read source code of any tool and generate an DragonClaw skill from it
author: DragonClaw
version: 1.0.0
triggers:
  - "ingest tool"
...
Read source code of any external tool and generate a proper DragonClaw SKILL.md file.
...
3. **Generate SKILL.md** with:
   ...
   - How DragonClaw should invoke or reference it
...
author: DragonClaw (generated from [original tool])
version: 1.0.0
triggers:
  - "keyword 1"
  - "keyword 2"
